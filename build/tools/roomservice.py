...
custom_dependencies = "radon.dependencies"
org_manifest = "radon-devices"  # leave empty if org is provided in manifest
org_display = "RadonOS-Devices"  # needed for displaying
